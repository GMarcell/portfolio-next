...
export function SkillsSection() {
  return (
    <section className="border-t border-line px-12 max-md:px-6 py-28 max-md:py-16 bg-surface" id="skills">
      <div data-reveal>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-px border border-line bg-line" data-reveal>
        {skillGroups.map((group) => (
          <div key={group.title} className="p-8 bg-dark transition-colors duration-200 hover:bg-surface">
            ...
            <div className="flex flex-col gap-[0.7rem]">
              {group.items.map((item) => (
                <div key={item.name} className="flex items-center justify-between gap-4">
                  ...
                  <div className="relative w-20 h-[3px] bg-line">
                    <div
                      className="skill-bar"
